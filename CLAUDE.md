...
- `docs/`: the pages for readers (`index.md`, `gameplay.md`, `turn.md`, `architecture.md`, `integrity.md`, `chronicle.md`, `operations.md`), each opening with a D2 grid-snake diagram from `docs/diagrams/` (light and dark SVG, committed; `render.sh` regenerates them; `docs/diagrams/CLAUDE.md` has the rules). Numbers in the pages and diagrams (limits, constants) mirror the code and Terraform: change them together.
